...
mSet<-PlotQEA.MetSet(mSet, "Amino sugar and nucleotide sugar metabolism", "png", 72, width=NA)
mSet<-PlotQEA.MetSet(mSet, "Amino sugar and nucleotide sugar metabolism", "png", 72, width=NA)
mSet<-PlotQEA.MetSet(mSet, "Pentose and glucuronate interconversions", "png", 72, width=NA)
